...
{
    // Ranger helmet for the Roaring armor set
    // Provides ranged damage and ammo conservation bonuses
    [AutoloadEquip(EquipType.Head)]
    public class RoaringMask : ModItem, IExtendedHat
    {
        ...
        public string ExtensionTexture => "DeterministicChaos/Content/Items/Armor/RoaringMask_Extension";
