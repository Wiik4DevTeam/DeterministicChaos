...
{
    public class ToyerKnifePlayer : ModPlayer
    {
        ...
        // Temporary bonus system (inherited from ToyKnife)
        ...
        private const float MAX_TEMP_STEALTH = 0.2f;

        // Mana and stealth granted per hit
        private const int MANA_PER_HIT = 20;
        private const float STEALTH_PER_HIT = 0.02f;

        // Tracking whether player is holding the Toyer Knife
        public bool isHoldingToyerKnife = false;
        ...
        public void OnToyerKnifeHit(NPC target)
        {
