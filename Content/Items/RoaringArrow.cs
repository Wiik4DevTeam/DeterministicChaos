...
{
    // Arrow ammo for the Roaring Knight weapon set
    // Pauses in place, shows an indicator, then dashes forward
    public class RoaringArrow : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<RoaringArrowProjectile>();
            Item.shootSpeed = 1f;
        ...
        public override void AddRecipes()
        {
            CreateRecipe(66)
                ...
                .AddIngredient(ItemID.WoodenArrow, 66)
