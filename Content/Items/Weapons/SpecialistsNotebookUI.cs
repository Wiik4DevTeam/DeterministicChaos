...
{
    public class SpecialistsNotebookUISystem : ModSystem
    {
        internal SpecialistsNotebookUIState NotebookUI;
        ...
        public override void Load()
        {
            if (!Main.dedServ)
            {
                NotebookUI = new SpecialistsNotebookUIState();
                NotebookUI.Activate();
        ...
        public override void ModifyInterfaceLayers(List<GameInterfaceLayer> layers)
        {
            ...
            if (inventoryIndex != -1)
            {
                layers.Insert(inventoryIndex + 1, new LegacyGameInterfaceLayer(
                    "DeterministicChaos: Specialists Notebook",
                    delegate
                    {
                        if (isOpen)
                        {
    ...
    public class SpecialistsNotebookUIState : UIState
    {
        ...
        // All word effects including the new Specialist's ones
        public static readonly Dictionary<string, string> WordEffects = new Dictionary<string, string>()
        {
            ...
            // New Specialist's Notebook words
        ...
        public override void OnInitialize()
        {
            ...
            titleText = new UIText("Specialist's Notebook", 1.1f, true);
        ...
        private void PopulateWordList()
        {
            ...
            foreach (var pair in WordEffects)
            {
                ...
                {
                    SpecialistsWordEffectEntry entry = new SpecialistsWordEffectEntry(pair.Key, pair.Value);
                    wordList.Add(entry);
                }
            }
        }
        ...
        {
            ModContent.GetInstance<SpecialistsNotebookUISystem>().CloseUI();
        }
    ...
    public class SpecialistsWordEffectEntry : UIPanel
    {
        private string wordName;
        private string wordEffect;

        public SpecialistsWordEffectEntry(string name, string effect)
        {
            wordName = name;
            wordEffect = effect;
            Width.Set(0, 1f);
