    ...
    public class DarkShard : ModItem
    {
        ...
        public override bool? UseItem(Player player)
        {
            if (player.altFunctionUse == 2)
            {
                ...
                ActivateDarkWorldPortalStatic(player);
                return true;
            }
        ...
        public static void ActivateDarkWorldPortalStatic(Player player)
        {
            ...
            DarkDimension.SourceBiome = DetectBiomeStatic(player);
        ...
        public static DarkDimension.BiomeType DetectBiomeStatic(Player player)
        {
