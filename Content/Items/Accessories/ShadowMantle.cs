...
namespace DeterministicChaos.Content.Items.Accessories
{
    ...
    public class ShadowMantle : ModItem
    {
        public override void Load()
        {
            ...
            {
                EquipLoader.AddEquipTexture(Mod, "DeterministicChaos/Content/Items/Accessories/ShadowMantle_Neck", EquipType.Neck, this);
            }
        }
    ...
    public class ShadowMantleArmsLayer : PlayerDrawLayer
    {
        ...
        protected override void Draw(ref PlayerDrawSet drawInfo)
        {
            if (armsTexture == null)
            {
                armsTexture = ModContent.Request<Texture2D>("DeterministicChaos/Content/Items/Accessories/ShadowMantle_Arms");
            }
