...
{
    // Club bomb (23x23, 2 frames). Falls from sky, explodes into 3 Club projectiles in a spread.
    // ai[0] = target player index
    // ai[1] = target Y position
    public class ClubBomb : ModProjectile
    {
        // Tuning
        public static float FallSpeed = 6f;
        public static int ExplodeDelay = 10; // ticks after reaching target Y
        public static float SpreadAngle = MathHelper.ToRadians(15f);
        public static float ProjectileSpeed = 9f;
        ...
        private void Explode()
        {
            ...
            for (int i = -1; i <= 1; i++)
            {
                Vector2 dir = toPlayer.RotatedBy(SpreadAngle * i);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color glowColor = new Color(40, 160, 40) * (0.5f * spawnT);
