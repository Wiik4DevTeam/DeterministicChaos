...
{
    // Friendly diamond projectile spawned by Devilsknife on hit. High damage, no pierce.
    public class FriendlyDiamondProjectile : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color tint = Color.Lerp(Color.White, new Color(230, 150, 30), 0.7f);
